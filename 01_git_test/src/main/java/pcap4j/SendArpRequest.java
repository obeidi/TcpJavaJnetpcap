...
//  private static final MacAddress SRC_MAC_ADDR = MacAddress.getByName("fe80::5c80:6a6a:57a6:e0b3%10");
...
//    String strSrcIpAddress = "192.0.2.100"; // for InetAddress.getByName()
    String strSrcIpAddress = "127.0.0.1"; // for InetAddress.getByName()
//    String strDstIpAddress = args[0]; // for InetAddress.getByName()
    String strDstIpAddress = "127.0.0.1"; // for InetAddress.getByName()
